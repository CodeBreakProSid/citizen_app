...
import 'page_incident_platform_base_controller.dart';

class PageIncidentPlatformController
    extends PageIncidentPlatformBaseController {
  @override
  void onInit() {
  ...
  //******************************Create incident on platform*******************
  Future<void> submitIncidentOnPlatform(BuildContext context) async {
    try {
      if (uploadImages == null) {
        ...
        isUploading = true;
        incidentPlatformFormKey.currentState?.save();

        final String informerName =
            '${incidentPlatformFormKey.currentState?.fields['name']?.value}';
        final String informerAge =
            '${incidentPlatformFormKey.currentState?.fields['age']?.value}';
        final String informerMobileNo =
            '${incidentPlatformFormKey.currentState?.fields['mobileNo']?.value}';
        final String platformNumber =
            '${incidentPlatformFormKey.currentState?.fields['platformNo']?.value}';
        final String incidetDetails =
            '${incidentPlatformFormKey.currentState?.fields['incident']?.value}';
